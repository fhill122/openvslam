...
public:
    ...
    shot_vertex* create_vertex(const std::shared_ptr<data::MultiKeyframe>& keyfrm, const bool is_constant);
    ...
    shot_vertex* get_vertex(const std::shared_ptr<data::MultiKeyframe>& keyfrm) const;
    ...
    bool contain(const std::shared_ptr<data::MultiKeyframe>& keyfrm) const;
...
inline shot_vertex* shot_vertex_container::create_vertex(const std::shared_ptr<data::MultiKeyframe>& keyfrm, const bool is_constant) {
    return create_vertex(keyfrm->id_, keyfrm->getCamPose(), is_constant);
}
...
inline shot_vertex* shot_vertex_container::get_vertex(const std::shared_ptr<data::MultiKeyframe>& keyfrm) const {
...
inline bool shot_vertex_container::contain(const std::shared_ptr<data::MultiKeyframe>& keyfrm) const {
